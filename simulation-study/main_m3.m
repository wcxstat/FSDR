...
for rep=1:1000
    ...
    % epsilon=0;
    % Y=[Xbeta1',Xbeta2',Xbeta3',zeros(n,p-3)]+epsilon;
    % Y=[Xbeta1',Xbeta2',Xbeta3'];
    ...
    for i=1:n
        ...
        % Sigma=blkdiag([1,2/pi*atan(Xbeta1(i));2/pi*atan(Xbeta1(i)),1],eye(2));
        % Sigma=blkdiag([1,2/pi*asin(Xbeta1(i)/sqrt(1+Xbeta1(i)^2));2/pi*asin(Xbeta1(i)/sqrt(1+Xbeta1(i)^2)),1],0.1*eye(2));
